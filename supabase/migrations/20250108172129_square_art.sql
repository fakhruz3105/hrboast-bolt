-- Drop existing table and type with CASCADE
DROP TABLE IF EXISTS memos CASCADE;
DROP TYPE IF EXISTS memo_type CASCADE;
...
-- Insert sample memos
INSERT INTO memos (title, type, content)
VALUES
  ('Welcome to the Team', 'custom', 'Welcome to our organization! We are excited to have you join us.'),
  ('Year-End Bonus Announcement', 'bonus', 'We are pleased to announce the year-end bonus distribution details.');