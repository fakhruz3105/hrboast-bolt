...
DROP POLICY IF EXISTS "staff_interview_forms_select_policy" ON staff_interview_forms;
DROP POLICY IF EXISTS "staff_interview_forms_insert_policy" ON staff_interview_forms;
...
CREATE POLICY "staff_forms_select_policy"
  ON staff_interview_forms FOR SELECT
  USING (true);

CREATE POLICY "staff_forms_insert_policy"
