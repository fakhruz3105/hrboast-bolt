/*
  # Fix Evaluation Forms and Staff Levels Relationship

  1. Changes
    - Drop existing view first
    - Drop existing table if exists
    - Create junction table with proper constraints
    - Recreate view with updated relationships
...
DROP VIEW IF EXISTS evaluation_forms_with_details;

-- Now we can safely drop and recreate the table
DROP TABLE IF EXISTS evaluation_form_levels;
...
-- Recreate the view with updated relationships
CREATE VIEW evaluation_forms_with_details AS
SELECT 
  ef.*,
