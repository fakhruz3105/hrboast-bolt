...
-- Create RLS policies
CREATE POLICY "inventory_items_select_policy_v1"
  ON inventory_items FOR SELECT
  USING (true);

CREATE POLICY "inventory_items_insert_policy_v1"
  ON inventory_items FOR INSERT
  WITH CHECK (true);

CREATE POLICY "inventory_items_update_policy_v1"
  ON inventory_items FOR UPDATE
  USING (true);

CREATE POLICY "inventory_items_delete_policy_v1"
...
CREATE POLICY "inventory_images_select_policy_v1"
  ON storage.objects FOR SELECT
  USING (bucket_id = 'inventory-images');

CREATE POLICY "inventory_images_insert_policy_v1"
