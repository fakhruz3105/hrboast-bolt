-- First delete any existing staff records for Muslimtravelbug
DO $$
DECLARE
  v_company_id uuid;
BEGIN
...
BEGIN
  ...
  -- Insert staff members one by one to avoid conflicts
  ...
  -- [Each staff member follows the same pattern with their own BEGIN/EXCEPTION block]
