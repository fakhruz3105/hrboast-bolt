-- Add company_id column to warning_letters table
ALTER TABLE warning_letters
ADD COLUMN IF NOT EXISTS company_id uuid REFERENCES companies(id) ON DELETE CASCADE;

-- Create index for better performance
CREATE INDEX IF NOT EXISTS idx_warning_letters_company ON warning_letters(company_id);

-- Update create_warning_letter function to include company_id
...
BEGIN
  ...
  -- Insert warning letter with company_id
...
-- Update get_company_warning_letters function to use company_id
